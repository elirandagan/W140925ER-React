...
export default function App() {
  ...
  return (
    ...
    <div className="m-14 text-center">
      <h1 className="text-5xl text-[#5a7286]">Taliwind!!</h1>
      <p className="text-sm text-yellow-700">using tailwind</p>
      <button className="btn">My Button</button>
      <Button className="text-black" color="red">Flowbite Button</Button>
    </div>
  );
}
